...
A few days ago, I saw this [video](https://www.youtube.com/watch?v=qPtKv9fSHZY)
"it's in Spanish" about **Game of Life Conway** which show this idea of a simple
"game" created by [John Horton Conway](https://en.wikipedia.org/wiki/John_Horton_Conway).
Which simulate a [cellular automaton](https://en.wikipedia.org/wiki/Cellular_automaton).
